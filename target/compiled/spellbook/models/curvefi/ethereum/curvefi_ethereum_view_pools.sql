...
v2_pools_deployed AS (
    ...
    FROM
        ...
        p
        LEFT JOIN `curvefi_ethereum`.`CurveFactoryV2_call_deploy_pool`
...
pools AS (
    ...
    FROM
        ...
        LEFT JOIN `curvefi_ethereum`.`CurveFactory_evt_LiquidityGaugeDeployed`
        g
    ...
    FROM
        ...
        LEFT JOIN `curvefi_ethereum`.`CurveFactoryV2_evt_LiquidityGaugeDeployed`
        g2
