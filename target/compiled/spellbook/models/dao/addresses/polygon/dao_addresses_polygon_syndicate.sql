...
all_syndicate_daos as (
        SELECT 
            ...
            tokenAddress as dao 
        FROM `syndicate_v2_polygon`.`ERC20ClubFactory_evt_ERC20ClubCreated`
        
        WHERE evt_block_time >= '2022-03-10'
        ...
        SELECT 
            evt_block_time as block_time,
            tokenAddress as dao 
        FROM `syndicate_v2_polygon`.`PolygonClubFactoryMATIC_evt_ERC20ClubCreated`
        ...
        SELECT 
            evt_block_time as block_time,
            tokenAddress as dao 
        FROM `syndicate_v2_polygon`.`PolygonERC20ClubFactory_evt_ERC20ClubCreated`
