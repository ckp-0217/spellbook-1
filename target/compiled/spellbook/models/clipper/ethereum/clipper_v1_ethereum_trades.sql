...
WITH event_data as (
    SELECT
        ...
        '' AS trace_address,
        evt_index
    FROM  `clipper_ethereum`.`ClipperExchangeInterface_evt_Swapped`
    WHERE 1=1
    
    AND evt_block_time >= '2021-06-26'
...
LEFT JOIN `prices`.`usd` p_bought
    ...
    AND p_bought.minute >= '2021-06-26'
