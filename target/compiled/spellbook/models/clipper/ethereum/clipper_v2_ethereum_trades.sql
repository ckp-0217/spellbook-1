...
WITH event_data as (
    SELECT
        ...
        '' AS trace_address,
        evt_index
    FROM  `clipper_ethereum`.`ClipperCaravelExchange_evt_Swapped`
    WHERE 1=1
    
    AND evt_block_time >= '2022-04-15'
...
LEFT JOIN `prices`.`usd` p_bought
    ...
    AND p_bought.minute >= '2022-04-15'
