...
with dexs AS (
        ...
        SELECT
            ...
            evt_index
        FROM
            `hashflow_avalanche_c`.`Pool_evt_Trade`
        
        WHERE evt_block_time >= '2022-04-11'
        ...
        SELECT
            ...
            evt_index
        FROM
            `hashflow_avalanche_c`.`Pool_evt_LzTrade`
        ...
        SELECT
            ...
            evt_index
        FROM
            `hashflow_avalanche_c`.`Pool_evt_XChainTrade`
...
LEFT JOIN `prices`.`usd` p_bought
    ...
    AND p_bought.minute >= '2022-04-11'
