...
(
    ...
    FROM
        `defiswap_ethereum`.`CroDefiSwapPair_evt_Swap` t
    INNER JOIN `crodefi_ethereum`.`CroDefiSwapFactory_evt_PairCreated` f ON f.pair = t.contract_address
