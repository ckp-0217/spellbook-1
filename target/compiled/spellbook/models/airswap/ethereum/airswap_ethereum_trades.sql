...
(
    SELECT
        ...
        evt_index
    FROM `airswap_ethereum`.`Light_evt_Swap` e
    ...
    SELECT
        ...
        cast(NULL as double) AS amount_usd,
        evt_index
    FROM `airswap_ethereum`.`swap_evt_Swap` e
    ...
    SELECT
        ...
        cast(NULL as double) AS amount_usd,
        evt_index
    FROM `airswap_ethereum`.`Swap_v3_evt_Swap` e
...
LEFT JOIN `prices`.`usd` p_bought
    ...
    AND p_bought.minute >= '2019-12-20'
