...
with cryptopunks_bids_and_sales as (
    ...
    select  "PunkBought" as event_type
            ...
            , evt_block_time
            , evt_tx_hash
    from `cryptopunks_ethereum`.`CryptoPunksMarket_evt_PunkBought`
...
, bid_sales as (
    ...
    join `cryptopunks_ethereum`.`CryptoPunksMarket_evt_Transfer` b
...
, regular_sales as (
    select  "Buy" as event_type
            ...
            , a.evt_block_time
            , a.evt_tx_hash
    from `cryptopunks_ethereum`.`CryptoPunksMarket_evt_PunkBought` a
    left outer join `cryptopunks_ethereum`.`CryptoPunksMarket_evt_PunkTransfer` b
