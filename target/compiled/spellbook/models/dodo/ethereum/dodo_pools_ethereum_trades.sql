...
(
        ...
        SELECT
            ...
            s.evt_index
        FROM
            `dodo_ethereum`.`DODO_evt_SellBaseToken` s
        LEFT JOIN dodo_view_markets m
            on s.contract_address = m.market_contract_address
        WHERE 
        s.seller <> '0x91e1c84ba8786b1fae2570202f0126c0b88f6ec7'
        
        and
        
        
        s.seller <> '0x9b64c81ba54ea51e1f6b7fefb3cff8aa6f1e2a09'
        
        and
        
        
        s.seller <> '0xe6aafa1c45d9d0c64686c1f1d17b9fe9c7dab05b'
        
        and
        
        
        s.seller <> '0xe55154d09265b18ac7cdac6e646672a5460389a1'
        ...
        SELECT
            ...
            b.evt_index
        FROM
            `dodo_ethereum`.`DODO_evt_BuyBaseToken` b
        LEFT JOIN dodo_view_markets m
            on b.contract_address = m.market_contract_address
        WHERE 
        b.buyer <> '0x91e1c84ba8786b1fae2570202f0126c0b88f6ec7'
        
        and
        
        
        b.buyer <> '0x9b64c81ba54ea51e1f6b7fefb3cff8aa6f1e2a09'
        
        and
        
        
        b.buyer <> '0xe6aafa1c45d9d0c64686c1f1d17b9fe9c7dab05b'
        
        and
        
        
        b.buyer <> '0xe55154d09265b18ac7cdac6e646672a5460389a1'
        ...
        WHERE 
        trader <> '0x91e1c84ba8786b1fae2570202f0126c0b88f6ec7'
        
        and
        
        
        trader <> '0x9b64c81ba54ea51e1f6b7fefb3cff8aa6f1e2a09'
        
        and
        
        
        trader <> '0xe6aafa1c45d9d0c64686c1f1d17b9fe9c7dab05b'
        
        and
        
        
        trader <> '0xe55154d09265b18ac7cdac6e646672a5460389a1'
...
LEFT JOIN `prices`.`usd` p_bought
    ...
    AND p_bought.minute >= '2020-08-10'
