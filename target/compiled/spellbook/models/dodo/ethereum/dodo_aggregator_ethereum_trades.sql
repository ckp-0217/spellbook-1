...
(
        ...
        SELECT
            ...
            evt_index
        FROM
            `dodo_ethereum`.`DODOV1Proxy01_evt_OrderHistory`
        ...
        SELECT
            ...
            evt_index
        FROM
            `dodo_ethereum`.`DODOV1Proxy02_evt_OrderHistory`
        ...
        SELECT
            ...
            evt_index
        FROM
            `dodo_ethereum`.`DODOV1Proxy03_evt_OrderHistory`
        ...
        SELECT
            ...
            evt_index
        FROM
            `dodo_ethereum`.`DODOV1Proxy04_evt_OrderHistory`
        ...
        SELECT
            ...
            evt_index
        FROM
            `dodo_ethereum`.`DODOV2Proxy02_evt_OrderHistory`
        ...
        SELECT
            ...
            evt_index
        FROM
            `dodo_ethereum`.`DODORouteProxy_evt_OrderHistory`
...
LEFT JOIN `prices`.`usd` p_bought
    ...
    AND p_bought.minute >= '2020-12-14'
