...
(
        ...
        SELECT
            ...
            s.evt_index
        FROM
            `dodo_arbitrum`.`DODO_evt_SellBaseToken` s
        LEFT JOIN dodo_view_markets m
            on s.contract_address = m.market_contract_address
        WHERE 
        s.seller <> '0xd5a7e197bace1f3b26e2760321d6ce06ad07281a'
        
        and
        
        
        s.seller <> '0x8ab2d334ce64b50be9ab04184f7ccba2a6bb6391'
        ...
        SELECT
            ...
            b.evt_index
        FROM
            `dodo_arbitrum`.`DODO_evt_BuyBaseToken` b
        LEFT JOIN dodo_view_markets m
            on b.contract_address = m.market_contract_address
        WHERE 
        b.buyer <> '0xd5a7e197bace1f3b26e2760321d6ce06ad07281a'
        
        and
        
        
        b.buyer <> '0x8ab2d334ce64b50be9ab04184f7ccba2a6bb6391'
        ...
        WHERE 
        trader <> '0xd5a7e197bace1f3b26e2760321d6ce06ad07281a'
        
        and
        
        
        trader <> '0x8ab2d334ce64b50be9ab04184f7ccba2a6bb6391'
        ...
        SELECT
            ...
            evt_index
        FROM
            `dodo_arbitrum`.`DPP_evt_DODOSwap`
        WHERE 
        trader <> '0xd5a7e197bace1f3b26e2760321d6ce06ad07281a'
...
LEFT JOIN `prices`.`usd` p_bought
    ...
    AND p_bought.minute >= '2021-08-30'
