...
(
        ...
        SELECT
            ...
            s.evt_index
        FROM
            `dodoex_bnb`.`DODO_evt_SellBaseToken` s
        LEFT JOIN dodo_view_markets m
            on s.contract_address = m.market_contract_address
        WHERE 
        s.seller <> '0x8e4842d0570c85ba3805a9508dce7c6a458359d0'
        
        and
        
        
        s.seller <> '0x0596908263ef2724fbfbcafa1c983fcd7a629038'
        
        and
        
        
        s.seller <> '0x165ba87e882208100672b6c56f477ee42502c820'
        
        and
        
        
        s.seller <> '0xab623fbcaeb522046185051911209f5b2c2a2e1f'
        ...
        SELECT
            ...
            b.evt_index
        FROM
            `dodoex_bnb`.`DODO_evt_BuyBaseToken` b
        LEFT JOIN dodo_view_markets m
            on b.contract_address = m.market_contract_address
        WHERE 
        b.buyer <> '0x8e4842d0570c85ba3805a9508dce7c6a458359d0'
        
        and
        
        
        b.buyer <> '0x0596908263ef2724fbfbcafa1c983fcd7a629038'
        
        and
        
        
        b.buyer <> '0x165ba87e882208100672b6c56f477ee42502c820'
        
        and
        
        
        b.buyer <> '0xab623fbcaeb522046185051911209f5b2c2a2e1f'
        ...
        WHERE 
        trader <> '0x8e4842d0570c85ba3805a9508dce7c6a458359d0'
        
        and
        
        
        trader <> '0x0596908263ef2724fbfbcafa1c983fcd7a629038'
        
        and
        
        
        trader <> '0x165ba87e882208100672b6c56f477ee42502c820'
        
        and
        
        
        trader <> '0xab623fbcaeb522046185051911209f5b2c2a2e1f'
...
LEFT JOIN `prices`.`usd` p_bought
    ...
    AND p_bought.minute >= '2021-02-22'
