...
(
        ...
        SELECT
            ...
            evt_index
        FROM
            `dodoex_bnb`.`DODOV2Proxy02_evt_OrderHistory`
        ...
        SELECT
            ...
            evt_index
        FROM
            `dodoex_bnb`.`DODORouteProxy_evt_OrderHistory`
...
LEFT JOIN `prices`.`usd` p_bought
    ...
    AND p_bought.minute >= '2021-02-16'
