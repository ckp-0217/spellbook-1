...
(
        ...
        SELECT
            ...
            s.evt_index
        FROM
            `dodoex_polygon`.`DODO_evt_SellBaseToken` s
        LEFT JOIN dodo_view_markets m
            on s.contract_address = m.market_contract_address
        WHERE
        
            s.seller <> '0xdbfaf391c37339c903503495395ad7d6b096e192'
            
            and
            
        
            s.seller <> '0x6c30be15d88462b788dea7c6a860a2ccaf7b2670'
        ...
        SELECT
            ...
            b.evt_index
        FROM
            `dodoex_polygon`.`DODO_evt_BuyBaseToken` b
        LEFT JOIN dodo_view_markets m
            on b.contract_address = m.market_contract_address
        WHERE
        
            b.buyer <> '0xdbfaf391c37339c903503495395ad7d6b096e192'
            
            and
            
        
            b.buyer <> '0x6c30be15d88462b788dea7c6a860a2ccaf7b2670'
        ...
        WHERE
            ...
            trader <> '0xdbfaf391c37339c903503495395ad7d6b096e192'
            
            and
            
        
            trader <> '0x6c30be15d88462b788dea7c6a860a2ccaf7b2670'
...
LEFT JOIN `prices`.`usd` p_bought
    ...
    AND p_bought.minute >= '2021-05-17'
