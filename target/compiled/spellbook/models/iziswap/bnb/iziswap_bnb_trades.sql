...
left join `prices`.`usd` prices_b
    ...
    and prices_b.minute >= '2022-05-10'
    
    
-- price of sold tokens
left join `prices`.`usd` prices_s
    ...
    and prices_s.minute >= '2022-05-10'
