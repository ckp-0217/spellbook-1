...
(
	...
	FROM `polygon`.`logs` l
	INNER JOIN `chainlink_polygon`.`oracle_addresses` cfa ON l.contract_address = cfa.aggregator_address
	WHERE l.topic1 = '0x0559884fd3a460db3073b7fc896cc77986f16e378210ded43186175bf646fc5f'
        
        AND l.block_time >= '2020-10-26'
...
LEFT JOIN `chainlink_polygon`.`oracle_token_mapping` o ON c.proxy_address = o.proxy_address